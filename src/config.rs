...
/// Default max branch depth of the `categorize` discrimination net (`tag_engine::decision_tree`).
...
pub struct Config {
    ...
    /// Max branch depth of the `categorize` discrimination net (see `tag_engine::decision_tree`).
